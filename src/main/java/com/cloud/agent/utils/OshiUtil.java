...
public class OshiUtil {
     ...
     * @throws Exception
     */
    public static com.cloud.agent.entity.SystemInfo os(CentralProcessor processor, OperatingSystem os) throws Exception {
        com.cloud.agent.entity.SystemInfo systemInfo = new com.cloud.agent.entity.SystemInfo();
     ...
     * @return
     */
    public static SysLoadState getLoadState(com.cloud.agent.entity.SystemInfo systemInfo, CentralProcessor processor) throws Exception {
